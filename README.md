<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,40:2ea043,100:2ee6d6&height=210&section=header&text=baho&fontColor=ffffff&fontSize=72&fontAlignY=34&desc=ESP32%20%C2%B7%20red-team%20firmware%20%C2%B7%20yo%20i%20dev%20%E2%9A%A1&descAlignY=56&descSize=18" alt="header" />

<div align="center">

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=800&size=26&duration=2600&pause=700&color=2EE6D6&center=true&vCenter=true&width=640&height=55&lines=i+break+RF+for+fun;ESP32-S3+red-team+multitool;Sub-GHz+%2F+NFC+%2F+BLE+%2F+IR+%2F+NRF24;solder+now%2C+regret+later" alt="typing" />
...
```c
struct baho {
    char  *role     = "embedded / offensive-security tinkerer";
    char  *building = "BruceButBetter — ESP32-S3 red-team multitool";
    char  *into[]   = { "sub-GHz/RF", "NFC/RFID", "BLE", "IR", "DIY hardware" };
    char  *vibe     = "Flipper-Zero-on-a-breadboard";
    bool   sleeps   = false;          // the firmware compiles overnight
};
```
...
<img src="https://skillicons.dev/icons?i=cpp,c,python,arduino,git,linux,bash,vscode,github,raspberrypi&theme=dark&perline=10" alt="stack" />

<br><br>

![ESP32](https://img.shields.io/badge/ESP32-E7352C?style=flat-square&logo=espressif&logoColor=white)
![PlatformIO](https://img.shields.io/badge/PlatformIO-0d1117?style=flat-square&logo=platformio&logoColor=FF7F00)
![CC1101](https://img.shields.io/badge/CC1101-Sub--GHz-2ea043?style=flat-square)
![NFC](https://img.shields.io/badge/PN532-NFC%2FRFID-1f6feb?style=flat-square)
![NRF24](https://img.shields.io/badge/NRF24-2.4GHz-2ee6d6?style=flat-square&labelColor=0d1117)
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:2ee6d6,60:2ea043,100:0d1117&height=120&section=footer&text=for%20authorized%20testing%20%26%20education%20only&fontColor=ffffff&fontSize=15&fontAlignY=72" alt="footer" />
